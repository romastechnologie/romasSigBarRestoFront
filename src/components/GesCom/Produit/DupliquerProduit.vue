<template>
  ...
  <div class="card-body p-15 p-sm-20 p-md-25 p-lg-30 letter-spacing">
          <Form ref="produitForm" @submit="DupliquerProduit" :validation-schema="produitSchema" :initial-values="produitForm">
            <div class="row gx-1">
          <div class="col-md-12">
                ...
                <div class="row gx-1">
                  <div class="col-md-3">
                    <div class="form-group mb-3 mb-sm-3 mb-md-3">
                      ...
                      <Field type="text" v-model="codeProduit" name="code" class="form-control shadow-none fs-md-15 text-black"
                  ...
                  <div class="col-md-4">
                    <div class="form-group mb-sm-2 mb-md-2">
                      <label class="d-block text-black fw-semibold mb-1">
                        Nom du Produit<span class="text-danger">*</span>
                      </label>
                      <Field name="nomProd" type="text" v-model="prodName"
                        class="mb-2 form-control shadow-none fs-md-15 text-black"
                        placeholder="Entrer le nom du produit" />
                      <ul class="dropdown-menu show " v-if="produitOptions.length > 0">
                  ...
                  <div class="col-md-4">
                    <div class="form-group mb-3 mb-sm-3 mb-md-3">
                      ...
                      <Field name="nomStandar" type="text" v-model="prodNameS"
                        class="form-control shadow-none fs-md-15 text-black" placeholder="Entrer le nom" />
                      <ul class="dropdown-menu show " v-if="produitStanOptions.length > 0">
                  ...
                  <div class="col-md-4">
                    <div class="form-group mb-3 mb-sm-3 mb-md-3">
                      ...
                      <Field name="nomMarche" type="text" v-model="prodNameM"
                        class="form-control shadow-none fs-md-15 text-black" placeholder="Entrer le nom marché" />
                      <ul class="dropdown-menu show " v-if="produitMarOptions.length > 0">
                  ...
                  <div class="col-md-4">
                    <div class="form-group mb-3 mb-sm-3 mb-md-3">
                      ...
                      <Field name="uniteGestion" v-slot="{ field }">
                        <Multiselect :options="conditionnementgOptions" :searchable="true" track-by="label" label="label"
          ...
          <div class="col-md-4 mb-4">
            <div class="form-group mb-15 mb-sm-20 mb-md-25">
              ...
              <Field name="paysProduction" type="text" v-slot="{ field }">
                <Multiselect v-model="field.value" v-bind="field" :options="pays" 
                  :searchable="true" placeholder="Sélectionner le pays de fabrication" 
                />
              </Field>
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const DupliquerProduit = async (values, {resetForm}) => {
    ...
    const fetchMarque = async () => {
      try {
        const response = await ApiService.get("all/marques");
