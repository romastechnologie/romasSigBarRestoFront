    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table card-table table-vcenter text-nowrap">
          ...
          <tbody>
            <tr v-for="(domaineproduit, index) in produit?.domaineproduits" :key="index">
              <td>{{ domaineproduit.domaineActivite?.libelle }}</td>
                ...
                <div v-if="index !== 0"> <!-- Ajout de la condition ici -->
                  <span class="">
                    <a class="bullet me-3 btn f-w-500 background-light-danger font-danger" href="javascript:void(0);"
                      @click="suppression(domaineproduit.id, produit?.domaineproduits, 'domaineproduit', `le domaine ${domaineproduit.domaineActivite.libelle}`)">
          ...
          <div class="row">
            <div class="col">
              <h5 class="text-black fw-bold mt-4">omaines du produit</h5>
            </div>
            <div class="col">
