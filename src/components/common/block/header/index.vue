<template>
    ...
    <div class="header-wrapper col m-0">
        <div class="row">
            ...
            <div class="nav-right  col-10 pull-right right-header p-0 ms-auto">
                <ul class="nav-menus">
                    <li>
                    ...
                    <!--<li style="background-color: #7A70BA;">
                        <HeaderSearch />
                    </li>
                    <li class="onhover-dropdown">
                        <NotificationBox />
...
const PointDeVente = defineAsyncComponent(() => import("@/components/common/block/header/PointDeVente.vue"))
